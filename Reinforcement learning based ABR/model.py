...
class ActorCritic(nn.Module):
    def __init__(self, a_dim=216):
        ...
        self.a_conv2 = nn.Conv1d(1, 128, 4)
        self.a_conv3 = nn.Conv1d(1, 128, 4)
        self.a_conv4 = nn.Conv1d(1, 128, 4)
        self.a_conv5 = nn.Conv1d(1, 128, 4)
        self.a_conv6 = nn.Conv1d(1, 128, 4)
        self.a_fc7 = nn.Linear(1, 128)
        self.a_fc8 = nn.Linear(1, 128)
        self.a_fc9 = nn.Linear(1, 128)
        self.a_fc10 = nn.Linear(1, 128)
        self.a_fc = nn.Linear(22*128, 128)
        self.a_actor_linear = nn.Linear(128, self.a_dim)  # use softmax
        # self.softmax = nn.Softmax()

        # critic model
        self.c_fc0 = nn.Linear(1, 128)
        self.c_fc1 = nn.Linear(1, 128)
        self.c_conv2 = nn.Conv1d(1, 128, 4)
        self.c_conv3 = nn.Conv1d(1, 128, 4)
        self.c_conv4 = nn.Conv1d(1, 128, 4)
        self.c_conv5 = nn.Conv1d(1, 128, 4)
        self.c_conv6 = nn.Conv1d(1, 128, 4)
        self.c_fc7 = nn.Linear(1, 128)
        self.c_fc8 = nn.Linear(1, 128)
        self.c_fc9 = nn.Linear(1, 128)
        self.c_fc10 = nn.Linear(1, 128)
        self.c_fc = nn.Linear(22 * 128, 128)
    ...
    def forward(self, inputs, batch_size=1):
        ...
        split_2 = F.relu(self.a_conv2(inputs[:, 2:3, 0:8])).view(batch_size, -1)
        split_3 = F.relu(self.a_conv3(inputs[:, 3:4, 0:8])).view(batch_size, -1)
        ...
        # print(split_0.shape, split_2.shape, split_4.shape)
        ...
        split_2 = F.relu(self.c_conv2(inputs[:, 2:3, 0:8])).view(batch_size, -1)
        split_3 = F.relu(self.c_conv3(inputs[:, 3:4, 0:8])).view(batch_size, -1)
