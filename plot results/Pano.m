function [PSPNR, sumSize, sumViewedTilesArea, viewportQPsizePerGrid] = Pano(set,vid,sec,tileW,tileH,sizeLmt,nExtra)
% input: data of tiling and video information, output: PSPNR and total size of tile in Pano scheme
