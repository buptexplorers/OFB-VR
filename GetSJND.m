function [result]=GetSJND(img)
% input: orgFrameImg (generate from extractFrame.m)
% output: SJND value of a specific frame
B=[1,1,1,1,1;
   1,2,2,2,1;
   1,2,0,2,1;
   1,2,2,2,1;
...
G2=[0,0,1,0,0;      % luminance difference in main diagonal line
    0,8,3,0,0;
    1,3,0,-3,-1;
    0,0,-3,-8,0;
    0,0,-1,0,0];

G3=[0,0,1,0,0;      % luminance difference in paradiagonal
    0,0,3,8,0;
    -1,-3,0,3,1;
    0,-8,-3,0,0;
    0,0,-1,0,0];

G4=[0,1,0,-1,0;     % luminance difference in horizontal direction
    0,3,0,-3,0;
    0,8,0,-8,0;
    0,3,0,-3,0;
    0,1,0,-1,0];
